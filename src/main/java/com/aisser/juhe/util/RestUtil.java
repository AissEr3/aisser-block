...
public class RestUtil {
    ...
    public static <T> ResponseEntity<T> request(String url, HttpMethod method, HttpHeaders headers, JSONObject variables, Object params, Class<T> responseType) {
        ...
        log.info(" RestUtil  --- request ---  url {}, headers {} ", url, headers);
    ...
    /**
     * @author 发送请求 并将中文ecode
     * @date 24/5/2023 下午2:28
     * @param 
     * @return 
     **/
    public static JSONObject getAndUrlencoded(String url,JSONObject variables){
        return RestUtil.request(url, HttpMethod.GET, getHeader(MediaType.APPLICATION_FORM_URLENCODED_VALUE), variables, null, JSONObject.class).getBody();
    }
}
