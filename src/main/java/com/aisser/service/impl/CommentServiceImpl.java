...
import com.aisser.service.CommentService;
import com.aisser.util.EmailUtil;
import com.aisser.util.HTMLUtil;
...
import static com.aisser.constant.CommonConstant.*;
import static com.aisser.constant.RabbitMQConstant.EMAIL_EXCHANGE;
import static com.aisser.enums.CommentTypeEnum.*;
...
//            emailUtil.sendHtmlMail(emailDTO);
    ...
    private EmailDTO getEmailDTO(Comment comment, UserInfo userInfo, String fromNickname, String topicId, String title) {
        ...
        if (comment.getIsReview().equals(TRUE)) {
            ...
            map.put("content", "您收到了一条新的回复/审核，请前往后台管理页面处理");
        }
