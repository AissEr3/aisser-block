...
import com.aisser.enums.JobStatusEnum;
import com.aisser.exception.BizException;
import com.aisser.mapper.JobMapper;
import com.aisser.model.dto.JobDTO;
import com.aisser.model.dto.PageResultDTO;
import com.aisser.model.vo.JobRunVO;
import com.aisser.model.vo.JobSearchVO;
import com.aisser.model.vo.JobStatusVO;
import com.aisser.model.vo.JobVO;
import com.aisser.service.JobService;
import com.aisser.util.BeanCopyUtil;
import com.aisser.util.CronUtil;
import com.aisser.util.PageUtil;
import com.aisser.util.ScheduleUtil;
...
public class JobServiceImpl extends ServiceImpl<JobMapper, Job> implements JobService {
    ...
    private void checkCronIsValid(JobVO jobVO) {
        ...
        if(!valid) {
            throw new BizException("Cron表达式无效!");
        }
    }
