...
import com.aisser.model.entity.*;
import com.aisser.mapper.*;
...
public class AuroraInfoServiceImpl implements AuroraInfoService {
    ...
    public AuroraAdminInfoDTO getAuroraAdminInfo() {
        ...
        Map<Object, Double> articleMap = null;
        redisService.zReverseRangeWithScore(ARTICLE_VIEWS_COUNT, 0, 4);
    ...
    public WebsiteConfigDTO getWebsiteConfig() {
        ...
        if (Objects.nonNull(websiteConfig)) {
            ...
            redisService.set(WEBSITE_CONFIG, config,60*60*24);
        }
