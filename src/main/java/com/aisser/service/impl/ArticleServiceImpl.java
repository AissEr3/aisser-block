...
import com.aisser.consumer.SubscribeConsumer;
import com.aisser.model.entity.Article;
import com.aisser.model.entity.ArticleTag;
import com.aisser.model.entity.Category;
import com.aisser.model.entity.Tag;
import com.aisser.enums.FileExtEnum;
import com.aisser.enums.FilePathEnum;
import com.aisser.exception.BizException;
import com.aisser.mapper.ArticleMapper;
import com.aisser.mapper.ArticleTagMapper;
import com.aisser.mapper.CategoryMapper;
import com.aisser.mapper.TagMapper;
import com.aisser.model.dto.*;
import com.aisser.model.vo.*;
import com.aisser.service.ArticleService;
import com.aisser.service.ArticleTagService;
import com.aisser.service.RedisService;
import com.aisser.service.TagService;
import com.aisser.strategy.context.SearchStrategyContext;
...
import static com.aisser.constant.RabbitMQConstant.SUBSCRIBE_EXCHANGE;
import static com.aisser.constant.RedisConstant.ARTICLE_ACCESS;
import static com.aisser.constant.RedisConstant.ARTICLE_VIEWS_COUNT;
import static com.aisser.enums.ArticleStatusEnum.DRAFT;
import static com.aisser.enums.StatusCodeEnum.ARTICLE_ACCESS_FAIL;
...
public class ArticleServiceImpl extends ServiceImpl<ArticleMapper, Article> implements ArticleService {
    ...
    public void saveOrUpdateArticle(ArticleVO articleVO) {
        ...
        if (Objects.isNull(articleVO.getUserId())) {
            articleVO.setUserId(UserUtil.getUserDetailsDTO().getUserInfoId());
        }
